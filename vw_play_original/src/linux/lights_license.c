...
/*   Updated: 2023/02/28 12:05:10 by obibby           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	license_one(t_car *car)
{
	...
	if (!EasterEggLightsEE.LicensePlateLight1)
	{
		...
		alpha = EasterEggLightsEE.LicensePlateLight1PWM * 0.0009;
	while (++y < 150)
	{
		x = x_base - x_length;
...
void	license_two(t_car *car)
{
	...
	if (!EasterEggLightsEE.LicensePlateLight2)
	{
		...
		alpha = EasterEggLightsEE.LicensePlateLight2PWM * 0.0009;
	while (++y < 150)
	{
		x = x_base - x_length;
		while (++x < x_base + x_length)
...
void	license_three(t_car *car)
{
	...
	if (!EasterEggLightsEE.LicensePlateLight3)
	{
		...
		alpha = EasterEggLightsEE.LicensePlateLight3PWM * 0.0009;
	while (++y < 150)
	{
		x = x_base - x_length;
		while (++x < x_base + x_length)
...
void	license_four(t_car *car)
{
	...
	if (!EasterEggLightsEE.LicensePlateLight4)
	{
		...
		alpha = EasterEggLightsEE.LicensePlateLight4PWM * 0.0009;
	while (++y < 150)
	{
		x = x_base - x_length;
		while (++x < x_base + x_length)
...
void	license_five(t_car *car)
{
	...
	if (!EasterEggLightsEE.LicensePlateLight5)
	{
		...
		alpha = EasterEggLightsEE.LicensePlateLight5PWM * 0.0009;
	while (++y < 150)
	{
		x = x_base - x_length;
		while (++x < x_base + x_length)
