...
/*   Updated: 2023/02/28 12:03:30 by obibby           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	license_one(t_car *car)
{
	...
	if (!EasterEggLightsEE.LicensePlateLight1)
	{
		...
		alpha = 255 - EasterEggLightsEE.LicensePlateLight1PWM * 255 * 0.0009;
	while (++y < 150)
	{
		x = x_base - x_length;
...
void	license_two(t_car *car)
{
	...
	if (!EasterEggLightsEE.LicensePlateLight2)
	{
		...
		alpha = 255 - EasterEggLightsEE.LicensePlateLight2PWM * 255 * 0.0009;
	while (++y < 150)
	{
		x = x_base - x_length;
		while (++x < x_base + x_length)
...
void	license_three(t_car *car)
{
	...
	if (!EasterEggLightsEE.LicensePlateLight3)
	{
		...
		alpha = 255 - EasterEggLightsEE.LicensePlateLight3PWM * 255 * 0.0009;
	while (++y < 150)
	{
		x = x_base - x_length;
		while (++x < x_base + x_length)
...
void	license_four(t_car *car)
{
	...
	if (!EasterEggLightsEE.LicensePlateLight4)
	{
		...
		alpha = 255 - EasterEggLightsEE.LicensePlateLight4PWM * 255 * 0.0009;
	while (++y < 150)
	{
		x = x_base - x_length;
		while (++x < x_base + x_length)
...
void	license_five(t_car *car)
{
	...
	if (!EasterEggLightsEE.LicensePlateLight5)
	{
		...
		alpha = 255 - EasterEggLightsEE.LicensePlateLight5PWM * 255 * 0.0009;
	while (++y < 150)
	{
		x = x_base - x_length;
		while (++x < x_base + x_length)
