...
/*   Updated: 2023/02/28 12:03:07 by obibby           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	left_indicator_front(t_car *car)
{
	...
	if (!EasterEggLightsEE.BlinkLightLeft)
		...
		alpha = 255 - EasterEggLightsEE.BlinkLightLeftPWM * 255 * 0.0009;
	x = 126 - displace;
...
void	right_indicator_front(t_car *car)
{
	...
	if (!EasterEggLightsEE.BlinkLightRight)
	{
		...
		alpha = 255 - EasterEggLightsEE.BlinkLightRightPWM * 255 * 0.0009;
	x = 320 + displace;
